...
namespace AsteroidGame
{
    ...
    static class Game
    {
        ...
        private static List<Asteroid> __Asteroids = new ();
        private static int __NumberOfAsteroids = 1;
        ...
        public static void Load()
        {
            ...
            {
                __Medikits.Add(new Medikit(random.Next(50, Game.Height - 50)));
